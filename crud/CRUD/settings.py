...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS').split(",") #agarro lo que este en el allowed_hots ene el archivo.env
...
#vamos a modificar esto para usar postgres en vez de sqilte
DATABASES = {
    'default': {
